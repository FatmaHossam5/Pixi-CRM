...
const RolesAndPermissionSection = () => {
  ...
  const filteredRows = roles?.filter((row) => row?.name);
            ...
            <ul className="dropdown-menu">
              <li>
                <Link
                  ...
                  to={`/dashboard/customerProfile/${row.id}`}
                >
                  view
                </Link>
              </li>
                  ...
                  {roles &&
                    roles?.map((role) => {
                      return (
                        <>
                          <div className="col-3">
                            <div className="m-2 customer-view-card p-3">
                              <div className="view-card-head d-flex justify-content-between flex-wrap">
                                <div className="card-name d-flex w-90 align-items-center">
                                ...
                                <div className="users-number w-100 gray-text">
                                  {role?.user_count} Users have this role
                                </div>
                              </div>
                              <div className="view-card-body mt-3 gray-text">
                                <div className="roles">
                                  <ul>
                                    {role.permissions?.map((list) => {
                                      return (
                                        <>
                                          <li className="d-flex justify-content-between my-1">
                                            <span>
                                              {list.permission_id.name}
                                            </span>
                                            {/* {console.log(list.permission_id.name) */}
                                            {/* } */}
                                            <div className="icon">
                                              <svg
                                                width={14}
                                                ...
                                                xmlns="http://www.w3.org/2000/svg"
                                              >
                                                <g clipPath="url(#clip0_2841_9955)">
                                                  <path
                                                    d="M13.6747 2.28614C13.2415 1.8524 12.5381 1.85267 12.1044 2.28614L5.03702 9.3538L1.89587 6.21268C1.46213 5.77894 0.759044 5.77894 0.325304 6.21268C-0.108435 6.64642 -0.108435 7.3495 0.325304 7.78324L4.25157 11.7095C4.46831 11.9262 4.7525 12.0349 5.03672 12.0349C5.32094 12.0349 5.6054 11.9265 5.82213 11.7095L13.6747 3.85667C14.1084 3.42324 14.1084 2.71985 13.6747 2.28614Z"
                                                    fill="#17C653"
                                                  />
                                                </g>
                                                <defs>
                                                  <clipPath id="clip0_2841_9955">
                                                    <rect
                                                      width={14}
                                                      height={14}
                                                      fill="white"
                                ...
                                <div className="view-action mt-3">
                                  <Link
                                    className="blue-text"
                                    to={`roleDetails/${
                                      role.id
...
export default RolesAndPermissionSection;
