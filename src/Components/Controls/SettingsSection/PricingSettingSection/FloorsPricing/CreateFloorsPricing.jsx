        ...
        const CreateFloorsPricing = () => {
          ...
          const createFloorPricing = async (data) => {
            console.log(data);

            const postPricingData = async (extraData) => {
              return await axios.post(
                `${baseUrlPms}/floor_pricing_rule/store/`,
                {
                  created_by: userId,
                  updated_by: userId,
            ...
            try {
              ...
              await postPricingData({
                ...
                floor_price: data.floor_price_work_day,
              });
              if (data.workDays && data.workDays.length !== 0) {
                for (let index = 0; index < data.workDays.length; index++) {
                  ...
                  await postPricingData({
                    ...
                    special_day_branch_season_id: null,
                    weekend_branch_season_ids: null,
                    floor_price: workday.floor_price_work_day,
                  });
                }
              }
              ...
              await postPricingData({
                ...
                weekend_branch_season_ids: null,
                floor_price: data.floor_price_special_day,
              });
              if (data.specialDays && data.specialDays.length !== 0) {
                for (let index = 0; index < data.specialDays.length; index++) {
                  ...
                  await postPricingData({
                    ...
                    weekday_branch_season_id: null,
                    weekend_branch_season_ids: null,
                    floor_price: specialDay.floor_price_special_day,
                  });
                }
              }
              ...
              await postPricingData({
                ...
                floor_price: data.floor_price_week_end,
              });
              if (data.weekendDays && data.weekendDays.length !== 0) {
                for (let index = 0; index < data.weekendDays.length; index++) {
                  ...
                  await postPricingData({
                    ...
                    floor_price: weekendDay.floor_price_week_end,
                  });
                }
              }
                ...
                <div className="px-card p-4 text-capitalize ">
                    ...
                    <div className="w-100 d-flex flex-wrap align-items-center">
                      <div className="breadcrumbs-list mb-2 w-100">
                        <Breadcrumb>
                          ...
                          <Breadcrumb.Item>
                            <Link to={"/dashboard/pricing"}>Floors Pricing</Link>
                          </Breadcrumb.Item>
                          <Breadcrumb.Item active>Add New Floor Price</Breadcrumb.Item>
                        </Breadcrumb>
                      </div>
                  ...
                  >
                    <div className="reservation-side w-100  p-4 ">
                      ...
                      <div className="form-inputs container-fluid  gx-0"></div>
        ...
        export default CreateFloorsPricing;
