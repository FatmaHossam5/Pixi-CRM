...
const AllAddonsRequestsSection = () => {
  ...
  const getAddonsRequests = () => {
    axios
      .get(`${baseUrlPms}/request_addons/all/`, {
        headers: Headers,
      })
      .then((res) => {
            ...
            <div className="w-100 d-flex flex-wrap align-items-center">
              <div className="breadcrumbs-list mb-2 w-100">
                <Breadcrumb>
                  ...
                  <Breadcrumb.Item active>Addon Requests</Breadcrumb.Item>
                </Breadcrumb>
              </div>
...
export default AllAddonsRequestsSection;
